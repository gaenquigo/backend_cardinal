...
class Fix4FunctionAnexo51 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
        DROP FUNCTION IF EXISTS cardinal.anexo_5_1;
            ...
            from (select fsin.id, fsin.father_id, fsin.code, fsin.name, fsin.final_level,
                    ...
                    inner join (select fp.id as idPlan, fp.p_a_i_id as idPai, fp.year, fp.source_id, fp.value as proyectado,
                                    ...
                                    left join lateral(select sum(coalesce(fnd.value,0)) as recaudo,
                                        ...
                                        from (select distinct /*fpint.id as idPlanint,fph.history::json->>'id' as idPlanH,*/
                                                        cast(fph.history::json->>'value' as double precision) as valor
                                                from 
                                                cardinal.novelty_pais np
                                        ...
                                        group by fpint.id, fph.history::json->>'id', \"valor\") q2) q1) add_redd on true
