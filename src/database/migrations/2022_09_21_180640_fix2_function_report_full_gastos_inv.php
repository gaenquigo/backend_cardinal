...
class Fix2FunctionReportFullGastosInv extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        AS $$
            ...
            END IF;
                ...
                VALUES (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13,cons_17,grupo,1,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66);
                ...
                (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13, cons_12,grupo,2,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66 );
                ELSEIF id_act_tmp= 0 THEN
                select t.comprometido, t.presupuestado, t.com_nation,t.pre_nation, t.com_roy, t.pre_roy, t.com_fca, t.pre_fca, t.pagos, t.obligaciones
                into cons_fvalue_comitted, cons_fvalue_bugeted, cons_nation_comitted, cons_nation_bugeted, cons_roy_comitted,
                cons_roy_bugeted, cons_fca_comitted, cons_fca_bugeted,cons_pago, cons_oblig
                ...
                index_tmp := index_tmp+1;
                INSERT INTO temp_table_inv(id_lin,id_act,id,id_prod,id_obj,id_prog,id_proy, name,grupo_pai,level, presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13, cons_15,grupo,3,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66 );
                ELSEIF id_act_tmp= 0 THEN
                select t.comprometido, t.presupuestado, t.com_nation,t.pre_nation, t.com_roy, t.pre_roy, t.com_fca, t.pre_fca, t.pagos, t.obligaciones
                into cons_fvalue_comitted, cons_fvalue_bugeted, cons_nation_comitted, cons_nation_bugeted, cons_roy_comitted,
                cons_roy_bugeted, cons_fca_comitted, cons_fca_bugeted,cons_pago, cons_oblig
            ...
            -- se agrega el objetivo
                ...
                index_tmp := index_tmp+1;
                INSERT INTO temp_table_inv(id_lin,id_act,id,id_prod,id_obj,id_prog,id_proy,name,grupo_pai,level,presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13,'OBJETIVO: ' || cons_8,grupo,4,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66);
                ELSEIF id_act_tmp= 0 THEN
                select t.comprometido, t.presupuestado, t.com_nation,t.pre_nation, t.com_roy, t.pre_roy, t.com_fca, t.pre_fca, t.pagos, t.obligaciones
                into cons_fvalue_comitted, cons_fvalue_bugeted, cons_nation_comitted, cons_nation_bugeted, cons_roy_comitted,
                cons_roy_bugeted, cons_fca_comitted, cons_fca_bugeted,cons_pago, cons_oblig
                ...
                INSERT INTO temp_table_inv(id_lin,id_act,id,id_prod,id_obj,id_prog,id_proy,name,grupo_pai,level,presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)
                VALUES 
                (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13, 'PRODUCTO: ' || cons_72,grupo,5,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66);
                ...
                */
                ...
                INSERT INTO temp_table_inv(id_lin,id_act,id,id_prod,id_obj,id_prog,id_proy, name,grupo_pai,level, presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)
                VALUES 
                (cons_16,cons_1,index_tmp,cons_69,cons_2,cons_14,cons_13,cons_4,grupo,6,cons_22,cons_26,cons_obligaciones,cons_pagos,cons_61,cons_62,cons_63,cons_64,cons_65,cons_66);
