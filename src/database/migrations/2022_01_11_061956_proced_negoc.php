...
class ProcedNegoc extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_acciones(
            p_pai_id bigint,
            p_year integer)
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_acciones (
            ...
            _anio1 = (select count(anio_table.*) from (select distinct
                        ...
                        where
                              indicators.abbreviated_name like 'IPRVAA'
        ...
        RETURN QUERY 
        SELECT *
        from negoc_acciones; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_acciones;
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_ejecucion_fisica(
            p_pai_id bigint,
            p_year integer)
            RETURNS TABLE(id bigint, name character varying, tematica character varying, cuatrienal double precision, anual double precision, presupuesto_ini double precision, presupuesto_def double precision, compromisos double precision, payment double precision) AS $$
        declare
            reg Record;
            reg1 Record;
            id integer;
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_ejecucion_fisica (
                id bigint,
            ...
            for reg in
                (select
                    ...
                    string_agg(negoc_acciones.tematica, ', ') as tematica
                ...
                group by
                   ...
                   loop
                    ...
                    insert into negoc_ejecucion_fisica (
                        id,
                        name,
                        tematica,
                        cuatrienal,
        ...
        RETURN QUERY 
        SELECT *
        from negoc_ejecucion_fisica; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_ejecucion_fisica;
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_ejecucion_fisica_tot(
            p_pai_id bigint,
            p_year integer)
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_ejecucion_fisica_tot (
                presupuesto_ini double precision,
                presupuesto_def double precision,
            ...
            presupuesto_ini_tot = (select
                                    ...
                                    from
                                    (SELECT
                                        negoc_ejecucion_fisica.presupuesto_ini
                                    from public.negoc_ejecucion_fisica(
                                        p_pai_id, 
                                        p_year
                                    )) as table1);
            presupuesto_def_tot = (select
                                    ...
                                    from
                                    (SELECT
                                        negoc_ejecucion_fisica.presupuesto_def
                                    from public.negoc_ejecucion_fisica(
                                        p_pai_id, 
                                        p_year
                                    )) as table1);
            compromiso_tot = (select
                                    ...
                                    from
                                    (SELECT
                                        negoc_ejecucion_fisica.compromisos
                                    from public.negoc_ejecucion_fisica(
                                        p_pai_id, 
                                        p_year
                                    )) as table1);	
            payment_tot = (select
                                    ...
                                    from
                                    (SELECT
                                        negoc_ejecucion_fisica.payment
                                    from public.negoc_ejecucion_fisica(
                                        p_pai_id, 
                                        p_year
                                    )) as table1);
            insert into negoc_ejecucion_fisica_tot (
                presupuesto_ini,
                presupuesto_def,
                compromiso,
                payment
        ...
        RETURN QUERY 
        SELECT *
        from negoc_ejecucion_fisica_tot; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_ejecucion_fisica_tot;
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_ejecucion_presupuesto(
            p_pai_id bigint,
            p_year integer)
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_ejecucion_presupuesto (
                id bigint,
            ...
            for reg in
                ...
                group by
                   ...
                   loop
                    ...
                    END IF;
                    --ejecucion = anual * ponderacion;
                    insert into negoc_ejecucion_presupuesto (
                        id,
                        ponderacion,
                        anual,
                        comp_pres,
        ...
        RETURN QUERY 
        SELECT *
        from negoc_ejecucion_presupuesto; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_ejecucion_presupuesto;
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_ejecucion_presupuesto_tot(
            p_pai_id bigint,
            p_year integer)
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_ejecucion_presupuesto_tot (
                id bigint,
                ponderacion double precision,
                anual double precision,
                comp_pres double precision,
            ...
            for reg in
                (SELECT * from public.negoc_ejecucion_presupuesto(
                    p_pai_id, 
                    p_year
                ))
                   loop
            ...
            insert into negoc_ejecucion_presupuesto_tot (
                id,
                ponderacion,
                anual,
                comp_pres,
        ...
        RETURN QUERY 
        SELECT *
        from negoc_ejecucion_presupuesto_tot; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_ejecucion_presupuesto_tot;
        
        end;
        $$ language plpgsql;");
				
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_presupuesto_def_tot(
            p_pai_id bigint,
            p_year integer)
            RETURNS TABLE(anio1 double precision, anio2 double precision, anio3 double precision, anio4 double precision, tot double precision) AS $$
        declare
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_presupuesto_def_tot (
                anio1 double precision,
                anio2 double precision,
                anio3 double precision,
                anio4 double precision,
            ...
            anio1 = (select
                            sum(negoc_ejecucion_fisica.presupuesto_def)
                        from negoc_ejecucion_fisica(
                            p_pai_id,
                            1
                        ));
            anio2 = (select
            ...
            insert into negoc_presupuesto_def_tot (
                anio1,
                anio2,
                anio3,
                anio4,
        ...
        RETURN QUERY 
        SELECT *
        from negoc_presupuesto_def_tot; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_presupuesto_def_tot;
        ...
        DB::unprepared("
        CREATE OR REPLACE FUNCTION public.negoc_prog(
            p_pai_id bigint,
            p_year integer)
            RETURNS TABLE(program_name character varying) AS $$
        declare
            reg Record;
            cur_plan_negoc cursor
                for select distinct
        ...
        --DROP TABLE temp_table;
            CREATE TEMP TABLE IF NOT EXISTS negoc_prog (
                program_name character varying
            );
        
            open cur_plan_negoc;
                LOOP
                    FETCH cur_plan_negoc INTO reg;
                    EXIT WHEN NOT FOUND;
                    IF int_id = 1 THEN
                ...
                END LOOP;
                INSERT INTO negoc_prog (
                        program_name
                    )
                    VALUES (
                        program_name
                    );
           close cur_plan_negoc;
           
        RETURN QUERY 
        SELECT *
        from negoc_prog; --where temp_table.father_id=5;
        --   return table;
        DROP TABLE negoc_prog;
