...
class FixGeneralV2Inv extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        AS $$
            ...
            END IF;
                ...
                END IF;
                    ...
                    INSERT INTO temp_table_inv(id_lin,id , name, level,presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)
            ...
            /*
                    ...
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_lin=cons_16 and temp_table_inv.level=1 Limit 1); 
                    ...
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv where temp_table_inv.id_lin=cons_16 and temp_table_inv.level=1 Limit 1); 
                    ...
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv where temp_table_inv.id_lin=cons_16 and temp_table_inv.level=1 Limit 1); 
                    ...
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv where temp_table_inv.id_lin=cons_16 and temp_table_inv.level=1 Limit 1); 
                    ...
                    */
                    ...
                    index_tmp := index_tmp+1;
                    INSERT INTO temp_table_inv(id_lin,id,id_prog,id_proy,name,level, presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                    ...
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_prog=cons_9 and temp_table_inv.level=2 Limit 1); 
                    ...
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv where temp_table_inv.id_prog=cons_9 and temp_table_inv.level=2 Limit 1);  
                    ...
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv where temp_table_inv.id_prog=cons_9 and temp_table_inv.level=2 Limit 1); 
                    ...
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv where temp_table_inv.id_prog=cons_9 and temp_table_inv.level=2 Limit 1); 
                    ...
                    */
                    ...
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_proy=cons_7 and temp_table_inv.level=3 Limit 1); 
                    ...
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv where temp_table_inv.id_proy=cons_7 and temp_table_inv.level=3 Limit 1); 
                    ...
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv where temp_table_inv.id_proy=cons_7 and temp_table_inv.level=3 Limit 1); 
                    ...
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv where temp_table_inv.id_proy=cons_7 and temp_table_inv.level=3 Limit 1); 
                ...
                */
                ...
                -- se agrega el objetivo
                    ...
                    index_tmp := index_tmp+1;
                    INSERT INTO temp_table_inv(id_lin,id,id_obj,id_prog,id_proy,name,level,presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                    ...
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_obj=cons_2 and temp_table_inv.level=4 Limit 1); 
                    ...
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv where temp_table_inv.id_obj=cons_2 and temp_table_inv.level=4 Limit 1); 
                    ...
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv where temp_table_inv.id_obj=cons_2 and temp_table_inv.level=4 Limit 1); 
                    ...
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv where temp_table_inv.id_obj=cons_2 and temp_table_inv.level=4 Limit 1); 		
                ...
                */
                    ...
                    index_tmp := index_tmp+1;
                    INSERT INTO temp_table_inv(id_lin,id, id_prod,id_obj,id_prog,id_proy,name,level,presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                    ...
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1); 
                    ...
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv  where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1); 
                    ...
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv  where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1); 
                    ...
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv  where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1); 		
                    ...
                    */
                    ...
                    index_tmp := index_tmp+1;
                    INSERT INTO temp_table_inv(id_lin,id_act,id,id_prod,id_obj,id_prog,id_proy, name,level, presupuestado, comprometido, obligaciones, pagos,pre_nation,com_nation,pre_roy,com_roy,pre_fca,com_fca)VALUES 
                    ...
                    ELSE
                    /*
                    cons_fvalue_comitted := (select temp_table_inv.comprometido from temp_table_inv where temp_table_inv.id_act=cons_1  and temp_table_inv.level=6 Limit 1);
                    cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_nation_comitted := (select temp_table_inv.com_nation from temp_table_inv where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_nation_bugeted := (select temp_table_inv.pre_nation from temp_table_inv  where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_roy_comitted := (select temp_table_inv.com_roy from temp_table_inv  where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_roy_bugeted := (select temp_table_inv.pre_roy from temp_table_inv  where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_fca_comitted := (select temp_table_inv.com_fca from temp_table_inv where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_fca_bugeted := (select temp_table_inv.pre_fca from temp_table_inv  where temp_table_inv.id_act=cons_1 and temp_table_inv.level=6 Limit 1); 
                    cons_pago:= (select temp_table_inv.pagos from temp_table_inv  where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1); 
                    cons_oblig:=(select temp_table_inv.obligaciones from temp_table_inv  where temp_table_inv.id_prod=cons_3 and temp_table_inv.level=5 Limit 1);  		
                    */			
                    select t.comprometido, t.presupuestado, t.com_nation,t.pre_nation, t.com_roy, t.pre_roy, t.com_fca, t.pre_fca, t.pagos, t.obligaciones
                ...
                --cons_fvalue_bugeted := (select temp_table_inv.presupuestado from temp_table_inv where temp_table_inv.id_prod=cons_3 Limit 1); 
                --update temp_table_inv set presupuestado=(cons_fvalue_bugeted + cons_43) where temp_table_inv.id_prod=cons_3;
