...
class Fix2FunctionAnexo1 extends Migration
{
    /**
     * Run the migrations.
     *
                ...
                FOR registro IN cur_codes LOOP
                    ...
                    IF id_prod_tmp = 0 THEN
                        ...
                        VALUES (registro.act_id,registro.id_pai,registro.id_lin,registro.product_id,registro.objective_id,registro.program_id,registro.project_id,
                                ...
                                registro.product_av_acum,registro.goal_anio,pc_av_fis,0,registro.product_met_fin,registro.product_av_fin,registro.product_av_oblig,registro.product_av_pagos,
