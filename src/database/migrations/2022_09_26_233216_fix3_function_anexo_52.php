...
class Fix3FunctionAnexo52 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        AS $$
            ...
            FOR select * from
            (
            --consulta fuentes de gastos padre sin grupo
            ...
            union
            --consulta fuentes de gastos padre con grupo
            select  distinct cs.id, cs.father_id, cs.code, cs.name, cs.final_level,
                    cast(0 as double precision) as presupuestado,
                    cast(0 as double precision) as comprometido,
                    cast(0 as double precision) as obligaciones,
            ...
            where p.id = p_paid
            and cs.final_level = false
            union
            --consulta fuentes de gastos de último nivel
