 ...
 */
class IndicatorsEvidencesController extends UtilsController
{
    /**
     * Valida y obtiene los indicadores 
     * asociados a una evidencia
     */
                ...
                if (!$responseValidation["errors"]) {
                    ...
                    if ($evidence) {
                        ...
                        if (sizeOf($indicator_activities) > 0) {
                            ...
                            $response_info->errors = ["No existe ningún registro de indicadores asociados a esta evidencia"];
                        }
                    } else {
            ...
            if ($validator->fails()) {
                ...
                if (!$responseValidation["errors"]) {
                    ...
                    if ($evidence) {
                        ...
                        $response_info->message = "Indicador asociado a la evidencia eliminado";
                        $errors = false;
                        FacadesDB::commit();
                    } else {
                        $response_info->errors = ["La evidencia con código  evidence_code " . $request->evidence_code . " no existe para la actividad en el año ingresado."];
     ...
     * y eliminar los indicadores de una evidencia
     */
